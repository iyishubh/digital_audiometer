          ...
          <div className="col-md-6">
            <div className="row address">
              <div className="col-2 d-flex align-items-center justify-content-center pl-3">
                <LocationOn color="primary" style={{ fontSize: 40 }} />
              </div>
            ...
            <div className="row email">
              ...
              <div className="col-10">
                <h4>Email:</h4>
                <p>digitalaudiometer@gmail.com</p>
              </div>
            </div>
            ...
            <div>
              <iframe
                ...
                marginheight="0"
                marginwidth="0"
                src="https://maps.google.com/maps?width=100%25&amp;height=250&amp;hl=en&amp;q=Pandit%20government+mca+college+maninagar&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
              ></iframe>
            </div>
          </div>
          <div className="col-md-6">
