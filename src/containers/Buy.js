  ...
  return (
    <>
      ...
      {isAuthenticated ? (
        <div className="container my-3">
          <div className="row">
            <div className="col-md-8 col-12 add-border">
              ...
              <figure>
                <img src={listing.photo_main} alt="Main Tasbir" width="100%" />
              </figure>
              <div className="row detail font-weight-bold">
                <div className="col-md-6">
                  <ul>
                    ...
                    <li>
                      <p className="m-1">Area: {listing.sqft} sqft.</p>
                    </li>
                  </ul>
                </div>
                <div className="col-md-6">
                  <ul>
                    <li>
                      <p className="m-1">Street: {listing.address}</p>
                    </li>
                    <li>
                      <p className="m-1">City: {listing.city}</p>
                    </li>
                    <li>
                      <p className="m-1">State: {listing.state}</p>
                    </li>
                    <li>
                      <p className="m-1">Zipcode: {listing.zipcode}</p>
                    </li>
                    <li>
                      <p className="m-1">country: {listing.country}</p>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="col-md-4 col-12 add-border p-0">
              ...
              <div className="row p-2">
                ...
                <div className="col-md-5">
                  <p>$ {listing.price + listing.price * 0.13}</p>
                </div>
              </div>
        ...
        <>
          <h1 className="text-center">You must login to see details.</h1>
